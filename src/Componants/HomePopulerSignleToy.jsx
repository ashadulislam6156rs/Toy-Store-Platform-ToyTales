...
const HomePopulerSignleToy = ({ sigleToy }) => {
  const { toyId, price, pictureURL, rating, availableQuantity, toyName } =
    sigleToy;
  return (
    <div>
      <div className="card bg-base-300 w-full shadow-sm p-3 hover:scale-97 transition-all duration-700 ease-in">
...
export default HomePopulerSignleToy;
